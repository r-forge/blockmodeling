...
RcppExport SEXP _StochBlock_meanByBlocks(SEXP MSEXP, SEXP cluSEXP, SEXP nCluSEXP, SEXP nSEXP, SEXP diagonalSEXP, SEXP sBordersSEXP, SEXP bordersMatLowerSEXP, SEXP bordersMatUpperSEXP, SEXP bordersSeperateLowerSEXP, SEXP bordersSeperateUpperSEXP, SEXP addOneSEXP, SEXP epsSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_StochBlock_meanByBlocks", (DL_FUNC) &_StochBlock_meanByBlocks, 12},
    {"_StochBlock_kmBlock", (DL_FUNC) &_StochBlock_kmBlock, 16},
    {"_StochBlock_critFunction", (DL_FUNC) &_StochBlock_critFunction, 15},
    {NULL, NULL, 0}
};

RcppExport void R_init_StochBlock(DllInfo *dll) {
